...
namespace meshutils {
  ...
  public:
    fbx_encoder(std::ostream &os) {
      ...
      os.write((const char*)fbx_header, sizeof(fbx_header));
  ...
  private:
    ...
    void L(long long value) {
    }

    void f(const float *value, size_t size) {
    }

    void d(const float *value, size_t size) {
    }

    void l(const float *value, size_t size) {
    }

    void i(const float *value, size_t size) {
    }

    void b(const bool *value, size_t size) {
    }
    ...
    void R(const void *value, size_t size) {
    }
  };
