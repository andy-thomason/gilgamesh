...
public:
  ...
  template <class Mesh>
  size_t build(Mesh &mesh, const glm::mat4 &transform = glm::mat4(), const glm::vec4 &color=glm::vec4(1), int num_y_segments=1, int num_radial_segments=32, int features=top|body|bottom) {
  ...
  void buildMesh(Vertex vertex, Index index, size_t first_index=0, int num_y_segments=1, int num_radial_segments=32, int features=top|body|bottom) {
